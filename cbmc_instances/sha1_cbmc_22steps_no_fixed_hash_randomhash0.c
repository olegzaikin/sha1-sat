...
int main() {
  ...
  __CPROVER_assume(output1[0] == 3466155663);
  __CPROVER_assume(output1[1] == 4036858694);
  __CPROVER_assume(output1[2] == 1663775144);
  __CPROVER_assume(output1[3] == 1226665262);
  __CPROVER_assume(output1[4] == 4156768968);
  __CPROVER_assume(output1[5] == 1684978051);
  __CPROVER_assume(output1[6] == 205246369);
  __CPROVER_assume(output1[7] == 486960399);
  __CPROVER_assume(output1[8] == 2802623355);
  __CPROVER_assume(output1[9] == 4146656196);
  __CPROVER_assume(output1[10] == 3421022695);
  __CPROVER_assume(output1[11] == 1891076045);
  __CPROVER_assume(output1[12] == 4158026838);
  __CPROVER_assume(output1[13] == 3126390800);
  __CPROVER_assume(output1[14] == 2949241235);
  __CPROVER_assume(output1[15] == 2955588879);
